...
def fetch_latest_crime_data(ti):
...
with DAG('fetch_kc_crime_data-v0.1', schedule_interval='@daily',
    ...
    fetch_crime_data = PythonOperator(
        task_id='fetch_crime_data',
        python_callable=fetch_latest_crime_data
    )
    ...
    is_api_available >> fetch_crime_window >> fetch_crime_data >> load_data
